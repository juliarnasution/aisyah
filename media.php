...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Aisyah Ilyas Collection adalah toko fashion online, yang menyediakan segala kebutuhan fashion anda. Aisyah Ilyas Collection ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja fashion berkualias dengan harga yang terjangkau.            </p>
        ...
        <div class="contactus">
        	<h5>Kontak Kami </h5>
            <ul>
            	<li class="tel"><span class="bold">Tel:</span> 024. 344444 </li>
                <li class="email"><span class="bold">Email:</span> <a href="mailto:aisyah@yahoo.com">aisyah_ilyas@yahoo.com</a></li>
                <li class="skype"><span class="bold">Skype:</span> Aisyah Ilyas Collection</li>
            </ul>
        </div>
        <div class="clear"></div>
        <div class="copyright_network">
        	<p>Copyright ©2017 Develoved by: Aisyah Ilyas Collection </p>
            <ul class="network"><li>
