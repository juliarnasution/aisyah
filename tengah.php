...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  echo "<tr><td colspan=6 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b></td></tr>
        <tr><td colspan=2><br /><a href=javascript:history.go(-1)><input style='width: 135px; height: 22px;' class= simplebtn value='LANJUTKAN BELANJA'></a><br /></td>
...
elseif ($_GET['module']=='hubungikami'){
  ...
  echo "<b> <div class='table5'>Hubungi kami secara online dengan mengisi form di bawah ini:</b>
        ...
        <form action=hubungi-aksi.html method=POST enctype='multipart/form-data'>
        ...
        <tr><td><span class='table4'>Nama Bank:</td><td>  <input type=text class='isikoment3' name=bank size=40></td></tr>
        <tr><td><span class='table4'>No. Rekening:</td><td>  <input type=text class='isikoment3' name=norek size=40></td></tr>
        <tr><td><span class='table4'>Jumlah Transfer:</td><td>  <input type=text class='isikoment3' name=bayar size=40></td></tr>
        <tr><td><span class='table4'>ID Order:</td><td>  <input type=text class='isikoment3' name=id_order size=40></td></tr>
        <tr><td><span class='table4'>Foto Bukti Pembayaran:</td><td>  <input type=file name='proof' size=40><br><br>Tipe gambar harus JPG/JPEG dan ukuran lebar maks: 400 px</td></tr>
...
$up = move_uploaded_file($_FILES['proof']['tmp_name'], "payment/".$_FILES['proof']['name']);
  
if($up){
	$q = mysql_query("insert into hubungi(nama, email, bank, norek, bayar, id_order, gambar,subjek,pesan,tanggal)
								values('$nama', '$email', '$bank', '$norek', '$bayar', '$id_order', '$namafile','$subjek','$pesan','$tanggal')");
	
	echo "<br><h3>Data Berhasil Di Kirim, Terima Kasih Atas Orderannya</h3> </br>";
	echo "<a href='store'><h4>Kembali Ke Menu Utama</h4></a>";
}else{
	 
	echo "<h3>Data Tidak Terkirim</h3>";
	//else echo "Data Berhasil Di Kirim, Terima Kasih Atas Orderannya";
